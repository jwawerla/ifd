...
src/ifd.so: /usr/lib/libICE.so
src/ifd.so: /usr/lib/libXrender.so
src/ifd.so: /usr/lib/libXrandr.so
src/ifd.so: /usr/lib/libXcursor.so
src/ifd.so: /usr/lib/libXfixes.so
src/ifd.so: /usr/lib/libfreetype.so
src/ifd.so: /usr/lib/libfontconfig.so
src/ifd.so: /usr/lib/libXext.so
src/ifd.so: /usr/lib/libX11.so
src/ifd.so: /usr/lib/libm.so
src/ifd.so: /usr/lib/qt4/libQtCore.so
src/ifd.so: /lib/libz.so
src/ifd.so: /usr/lib/libgthread-2.0.so
src/ifd.so: /usr/lib/libglib-2.0.so
src/ifd.so: /usr/lib/librt.so
src/ifd.so: /usr/lib/qt4/libQtGui.so
src/ifd.so: /usr/lib/libpng.so
src/ifd.so: /usr/lib/libSM.so
src/ifd.so: /usr/lib/libICE.so
